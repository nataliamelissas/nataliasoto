        ...
        <div className="relative z-10 max-w-4xl mx-auto px-8 md:px-16 lg:px-20 py-28">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border-2 border-ink-900/15 text-ink-900 px-7 py-3 rounded-full font-medium hover:border-ink-900 hover:bg-ink-900 hover:text-ivory-100 transition-all duration-300"
            >
