...
const HomePage: React.FC<HomePageProps> = ({contactSectionRef}) => {
  return (
    <div className="font-sans">
      ...
      {/* Section 3 */}
      <ScreenSection mode='dark' header='Software Engineering Experience' subheader='Full-time software engineering experience and B.S. Computer Science graduate.'>
        <div className='my-12'>
